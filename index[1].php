...
<head>
  ...
  <title>localhost / 127.0.0.1 / productdb | phpMyAdmin 5.2.1</title>
  ...
  <script data-cfasync="false" type="text/javascript" src="js/dist/makegrid.js?v=5.2.1"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/jquery/jquery.uitablefilter.js?v=5.2.1"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/sql.js?v=5.2.1"></script>
...
AJAX.scriptHandler
  ...
  .add('makegrid.js', 1)
  .add('vendor/jquery/jquery.uitablefilter.js', 0)
  .add('sql.js', 1)
...
<body>
  ...
  <a href="index.php?route=/table/recent-favorite&db=epemsdb.sql&table=codtbl">
    `epemsdb.sql`.`codtbl`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=productdb&table=products">
    `productdb`.`products`
  </a>
</li>
    ...
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.ZXBlbXNkYi5zcWw=" data-vpath="cm9vdA==.ZXBlbXNkYi5zcWw=" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=epemsdb.sql"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=epemsdb.sql" title="Structure">epemsdb.sql</a>
  ...
  <li class="database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.cHJvZHVjdGRi" data-vpath="cm9vdA==.cHJvZHVjdGRi" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=productdb"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=productdb" title="Structure">productdb</a>
  ...
  <li class="last database">
    ...
    <div class="clearfloat"></div>
      ...
      <div id="pma_navi_settings_container">
                  <div id="pma_navigation_settings"><div class="page_settings"><form method="post" action="index.php&#x3F;route&#x3D;&#x25;2Fdatabase&#x25;2Fsql&amp;db&#x3D;productdb&amp;server&#x3D;1" class="config-form disableAjax">
  <input type="hidden" name="tab_hash" value="">
      <input type="hidden" name="check_page_refresh" id="check_page_refresh" value="">
    <input type="hidden" name="token" value="3040323c3f36486c2c432460363e423a">
  ...
  <ol class="breadcrumb breadcrumb-navbar">
    <li class="breadcrumb-item">
      ...
      <a href="index.php?route=/" data-raw-text="127.0.0.1" draggable="false">
        ...
        <a href="index.php?route=/database/structure&db=productdb" data-raw-text="productdb" draggable="false">
          Database:          productdb
        </a>
      </li>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul id="topmenu" class="navbar-nav">
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/structure&db=productdb">
              <img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure
                          </a>
          </li>
                  <li class="nav-item active">
            <a class="nav-link text-nowrap" href="index.php?route=/database/sql&db=productdb">
              <img src="themes/dot.gif" title="SQL" alt="SQL" class="icon ic_b_sql">&nbsp;SQL
                              <span class="visually-hidden">(current)</span>
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/search&db=productdb">
              <img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_b_search">&nbsp;Search
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/multi-table-query&db=productdb">
              <img src="themes/dot.gif" title="Query" alt="Query" class="icon ic_s_db">&nbsp;Query
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/export&db=productdb">
              <img src="themes/dot.gif" title="Export" alt="Export" class="icon ic_b_export">&nbsp;Export
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/import&db=productdb">
              <img src="themes/dot.gif" title="Import" alt="Import" class="icon ic_b_import">&nbsp;Import
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/operations&db=productdb">
              <img src="themes/dot.gif" title="Operations" alt="Operations" class="icon ic_b_tblops">&nbsp;Operations
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/server/privileges&db=productdb&checkprivsdb=productdb&viewing_mode=db">
              <img src="themes/dot.gif" title="Privileges" alt="Privileges" class="icon ic_s_rights">&nbsp;Privileges
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/routines&db=productdb">
              <img src="themes/dot.gif" title="Routines" alt="Routines" class="icon ic_b_routines">&nbsp;Routines
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/events&db=productdb">
              <img src="themes/dot.gif" title="Events" alt="Events" class="icon ic_b_events">&nbsp;Events
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/triggers&db=productdb">
              <img src="themes/dot.gif" title="Triggers" alt="Triggers" class="icon ic_b_triggers">&nbsp;Triggers
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/tracking&db=productdb">
              <img src="themes/dot.gif" title="Tracking" alt="Tracking" class="icon ic_eye">&nbsp;Tracking
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/designer&db=productdb">
              <img src="themes/dot.gif" title="Designer" alt="Designer" class="icon ic_b_relations">&nbsp;Designer
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/central-columns&db=productdb">
              <img src="themes/dot.gif" title="Central columns" alt="Central columns" class="icon ic_centralColumns">&nbsp;Central columns
                          </a>
          </li>
              </ul>
    </div>
...
<div id="page_settings_modal"><div class="page_settings"><form method="post" action="index.php&#x3F;route&#x3D;&#x25;2Fdatabase&#x25;2Fsql&amp;db&#x3D;productdb&amp;server&#x3D;1" class="config-form disableAjax">
  <input type="hidden" name="tab_hash" value="">
      <input type="hidden" name="check_page_refresh" id="check_page_refresh" value="">
    <input type="hidden" name="token" value="3040323c3f36486c2c432460363e423a">
  ...
  <th>
    <label for="ShowSQL">Show SQL queries</label>
          ...
          <span class="doc">
        <a href="./doc/html/config.html#cfg_ShowSQL" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a>
      </span>
...
<tr>
  <th>
    <label for="Confirm">Confirm DROP queries</label>
          ...
          <span class="doc">
        <a href="./doc/html/config.html#cfg_Confirm" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a>
      </span>
...
<tr>
  <th>
    <label for="QueryHistoryMax">Query history length</label>
          ...
          <span class="doc">
        <a href="./doc/html/config.html#cfg_QueryHistoryMax" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a>
      </span>
...
<tr>
  <th>
    <label for="IgnoreMultiSubmitErrors">Ignore multiple statement errors</label>
          ...
          <span class="doc">
        <a href="./doc/html/config.html#cfg_IgnoreMultiSubmitErrors" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a>
      </span>
...
<tr>
  <th>
    <label for="MaxCharactersInDisplayedSQL">Maximum displayed SQL length</label>
          ...
          <span class="doc">
        <a href="./doc/html/config.html#cfg_MaxCharactersInDisplayedSQL" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a>
      </span>
...
<tr>
  <th>
    <label for="RetainQueryBox">Retain query box</label>
          ...
          <span class="doc">
        <a href="./doc/html/config.html#cfg_RetainQueryBox" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a>
      </span>
...
<tr>
  <th>
    <label for="CodemirrorEnable">Enable CodeMirror</label>
          ...
          <span class="doc">
        <a href="./doc/html/config.html#cfg_CodemirrorEnable" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a>
      </span>
...
<tr>
  <th>
    <label for="LintEnable">Enable linter</label>
          ...
          <span class="doc">
        <a href="./doc/html/config.html#cfg_LintEnable" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a>
      </span>
...
<tr>
  <th>
    <label for="EnableAutocompleteForTablesAndColumns">Enable autocomplete for table and column names</label>
          ...
          <span class="doc">
        <a href="./doc/html/config.html#cfg_EnableAutocompleteForTablesAndColumns" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a>
      </span>
...
<tr>
  <th>
    <label for="DefaultForeignKeyChecks">Foreign key checks</label>
          ...
          <span class="doc">
        <a href="./doc/html/config.html#cfg_DefaultForeignKeyChecks" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a>
      </span>
  ...
  <th>
    <label for="SQLQuery-Edit">Edit</label>
          ...
          <span class="doc">
        <a href="./doc/html/config.html#cfg_SQLQuery_Edit" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a>
      </span>
...
<tr>
  <th>
    <label for="SQLQuery-Explain">Explain SQL</label>
          ...
          <span class="doc">
        <a href="./doc/html/config.html#cfg_SQLQuery_Explain" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a>
      </span>
...
<tr>
  <th>
    <label for="SQLQuery-ShowAsPHP">Create PHP code</label>
          ...
          <span class="doc">
        <a href="./doc/html/config.html#cfg_SQLQuery_ShowAsPHP" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a>
      </span>
...
<tr>
  <th>
    <label for="SQLQuery-Refresh">Refresh</label>
          ...
          <span class="doc">
        <a href="./doc/html/config.html#cfg_SQLQuery_Refresh" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a>
      </span>
...
registerFieldValidator('MaxCharactersInDisplayedSQL', 'validatePositiveNumber', true);
...
</div></div><form method="post" action="index.php?route=/import" class="ajax lock-page" id="sqlqueryform" name="sqlform" enctype="multipart/form-data">
  <input type="hidden" name="db" value="productdb"><input type="hidden" name="token" value="3040323c3f36486c2c432460363e423a">
  <input type="hidden" name="is_js_confirmed" value="0">
  <input type="hidden" name="pos" value="0">
  <input type="hidden" name="goto" value="index.php?route=/database/sql">
  ...
  <input type="hidden" name="prev_sql_query" value="">
    ...
    <div class="card mb-3">
      <div class="card-header">Run SQL query/queries on database <a href="index.php?route=/database/structure&db=productdb">productdb</a>: <a href="./url.php?url=https%3A%2F%2Fdev.mysql.com%2Fdoc%2Frefman%2F8.0%2Fen%2Fselect.html" target="mysql_doc"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a></div>
      <div class="card-body">
        <div id="queryfieldscontainer">
          <div class="row">
            <div class="col">
              <div class="mb-3">
                <textarea class="form-control" tabindex="100" name="sql_query" id="sqlquery" cols="40" rows="15" data-textarea-auto-select="false" aria-label="SQL query"></textarea>
              </div>
              ...
              <div class="my-3">
                <div class="form-check">
                  ...
                  <label class="form-check-label" for="parameterized">
                    Bind parameters                    <a href="./doc/html/faq.html#faq6-40" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a>
                  </label>
                </div>
              </div>
...
<div class="modal fade" id="simulateDmlModal" tabindex="-1" aria-labelledby="simulateDmlModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <a href="index.php?route=%2Fdatabase%2Fsql&amp;db=productdb&amp;server=1" title="Open new phpMyAdmin window" target="_blank" rel="noopener noreferrer">
